...
class Distribution extends Knowthese {
    constructor(canvas) {
        super(canvas, 50);
    }
    setQuestionsAndOptions() {
        this.knowthis[0].setQuestionAndOptions('Distribution of Electricity in Nigeria', 'Distribution', 'Generation', 'Transmission');
        ...
        this.knowthis[2].setQuestionAndOptions('Installation of a 2MW plant by the kwali river by Tin miners', '1923', '1920', '1918');

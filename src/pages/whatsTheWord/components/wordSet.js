const WordSet = [
  ...
  { id: 21, correctWord: ['C', 'I', 'T', 'E'], scrambledWord: ['T', 'I', 'C', 'E'], hint: "Hint: (to mention or refer to a source of information or evidence. When writing an academic paper, it is essential to properly _ the sources used to avoid plagiarism.)", audio: '/assets/wordSound/cite.mp3' },
  ...
  { id: 41, correctWord: ['E', 'R', 'O', 'D', 'E'], scrambledWord: ['O', 'R', 'E', 'D', 'E'], hint: "Hint: (gradually destroy. Your relentless criticism will _ her self-confidence.)", audio: '/assets/wordSound/erode.mp3' },
  ...
  { id: 61, correctWord: ['D', 'E', 'T', 'E', 'R'], scrambledWord: ['T', 'E', 'D', 'E', 'R'], hint: "Hint: (discourage someone from doing something, often by creating fear about the consequences. The dogs were meant to _ unauthorized access to the building.)", audio: '/assets/wordSound/deter.mp3' },
  ...
  { id: 81, correctWord: ['Y', 'I', 'E', 'L', 'D'], scrambledWord: ['Y', 'E', 'I', 'L', 'D'], hint: "Hint: (produce or provide something. Despite their efforts, the team's project didn't _ the expected results.)", audio: '/assets/wordSound/yield.mp3' },
  ...
  { id: 101, correctWord: ['B', 'L', 'I', 'T', 'H', 'E'], scrambledWord: ['E', 'L', 'I', 'T', 'H', 'B'], hint: "Hint: (a carefree and cheerful demeanor. She faced her challenges with a _ spirit.)", audio: '/assets/wordSound/blithe.mp3' },
  ...
  { id: 121, correctWord: ['F', 'U', 'T', 'I', 'L', 'E'], scrambledWord: ['L', 'I', 'T', 'U', 'F', 'E'], hint: "Hint: (incapable of producing any useful result; pointless or ineffective. Despite best efforts, their struggle against the corporation proved _.)", audio: '/assets/wordSound/futile.mp3' },
  ...
  { id: 132, correctWord: ['B', 'E', 'N', 'I', 'G', 'N'], scrambledWord: ['Y', 'I', 'W', 'T', 'T', 'Y'], hint: "Hint: (persuade.)", audio: '/assets/wordSound/witty.mp3' },

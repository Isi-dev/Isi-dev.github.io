export const ArticlesData = [
  {
    ...
    author: "IOJ",
    date_s:"22ⁿᵈ September 2023",
    date_e:"Still writing",
    body_1: "Consider the folowing statements; 1. 'I'm literally a god! No one can match my skills and accomplishments.' 2. 'Oh look at me; I'm just too fine. I'm definitely the most beautiful person alive.' 3. 'I made him all he is.' 4. 'Keep your ideas to yourself. I've got it all figured out.' 5. 'I don't care what the data says; my gut feeling is always right.'",
    body_2: "The first speaker compares themselves to a deity, claims that they are superior to other human beings, and seeks the admiration that a god deserves. The second speaker is preoccupied with their physical appearance, probably imagines herself a goddess, and would love to be praised as objectively better looking than every one else. The third speaker wants the audience to admire them for their power and generosity. The fourth wants to be known for their great intellect and they are not willing to share their glory with anyone, while the fifth places excessive trust in their intuition like a supernatural being whose knowledge far exceeds the available data. Overall, the statements portray people with an extremely inflated sense of self-importance and they reflect the height of self-delusion in the spectrum of egotism.",
    body_3: "We are easily blinded to the facts that none of us chose to exist, none of us chose our genes, none of us chose our personalities, abilities and looks, none of us knows everything, and none of us can escape death.",
    body_4: "",
    body_5: "",
    body_6: "",
    body_7: "",
